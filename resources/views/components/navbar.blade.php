    ...
    <div class="flex items-center gap-2">
        ...
        <div class="relative">
            ...
            >
                ...
                <div class="py-1">
                    <a href="{{ route('dashboard.settings') }}#profile" class="block px-4 py-2 text-sm text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition" role="menuitem">Profile</a>
                    <a href="{{ route('dashboard.settings') }}" class="block px-4 py-2 text-sm text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition" role="menuitem">Settings</a>
