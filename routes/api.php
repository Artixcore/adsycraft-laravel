...
use App\Http\Controllers\Api\CompetitorUrlController;
use App\Http\Controllers\Api\GrowthBlueprintController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('businesses/{business}/growth-blueprints', [GrowthBlueprintController::class, 'index'])->name('businesses.growth-blueprints.index');
    Route::get('businesses/{business}/growth-blueprints/{growth_blueprint}', [GrowthBlueprintController::class, 'show'])->name('businesses.growth-blueprints.show');
    Route::post('businesses/{business}/growth-blueprints', [GrowthBlueprintController::class, 'store'])->name('businesses.growth-blueprints.store');
    Route::get('businesses/{business}/competitor-urls', [CompetitorUrlController::class, 'index'])->name('businesses.competitor-urls.index');
    Route::post('businesses/{business}/competitor-urls', [CompetitorUrlController::class, 'store'])->name('businesses.competitor-urls.store');
    Route::delete('businesses/{business}/competitor-urls/{competitor_url}', [CompetitorUrlController::class, 'destroy'])->name('businesses.competitor-urls.destroy');
